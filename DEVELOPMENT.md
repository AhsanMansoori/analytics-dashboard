...
```bash
git remote add encore encore://analytics-dashboard-kn22
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/analytics-dashboard-kn22/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/analytics-dashboard-kn22/settings/integrations/github)
