 ...
 */
import {
    exportData as api_analytics_dashboard_exportData,
    getDashboard as api_analytics_dashboard_getDashboard,
    getNotifications as api_analytics_dashboard_getNotifications,
    markNotificationRead as api_analytics_dashboard_markNotificationRead
...
export namespace analytics {
    ...
    export class ServiceClient {
         ...
         */
        public async exportData(params: RequestType<typeof api_analytics_dashboard_exportData>): Promise<ResponseType<typeof api_analytics_dashboard_exportData>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/analytics/export`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_analytics_dashboard_exportData>
        }
         ...
         * Get notifications
         */
        public async getNotifications(): Promise<ResponseType<typeof api_analytics_dashboard_getNotifications>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/analytics/notifications`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_analytics_dashboard_getNotifications>
        }

        /**
         * Mark notification as read
         */
        public async markNotificationRead(params: { id: string }): Promise<void> {
            await this.baseClient.callTypedAPI(`/analytics/notifications/${encodeURIComponent(params.id)}/read`, {method: "POST", body: undefined})
        }
    }
}
 ...
 */
import {
    getProfile as api_auth_auth_getProfile,
...
export namespace auth {
    ...
    export class ServiceClient {
         ...
         */
        public async getProfile(): Promise<ResponseType<typeof api_auth_auth_getProfile>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/auth/profile`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_auth_auth_getProfile>
        }
